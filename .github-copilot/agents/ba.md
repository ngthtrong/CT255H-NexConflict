...
Đọc file brief tại `.github-copilot/workspace/requirements/input/BRIEF-{ID}.md`. Nếu không tồn tại, báo lỗi rõ ràng.
...
Tạo file `.github-copilot/workspace/requirements/DRAFT-REQ-{ID}.md` theo cấu trúc:
