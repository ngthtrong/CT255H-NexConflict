...
- Thêm hệ thống agent vào repo hiện có chưa có `.claude/`
...
```
.claude/workspace/requirements/input/.gitkeep
.claude/workspace/tasks/.gitkeep
...
Tạo `.claude/PROJECT-PROFILE.md` với template trống để người dùng và `/detect-stack` điền vào.
...
3. Tạo brief tại .claude/workspace/requirements/input/BRIEF-00001.md
