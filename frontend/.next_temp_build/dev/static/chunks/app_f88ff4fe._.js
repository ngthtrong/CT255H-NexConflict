...
function LoginPage() {
    ...
    const { login } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$lib$2f$authContext$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAuth"])();
    ...
    const handleSubmit = async (e)=>{
        ...
        setError('');
        try {
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].post('/auth/login', {
                email,
                password
            });
...
_s(LoginPage, "CPj4jTF4JixIgvrjFpFhlxr4fBg=", false, function() {
    return [
...
//# sourceMappingURL=app_f88ff4fe._.js.map