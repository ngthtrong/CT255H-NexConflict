...
Tìm tất cả file `REQ-*.md` (không phải `DRAFT-REQ-*`) trong `.github-copilot/workspace/requirements/`.
...
Theo template tại `.github-copilot/templates/TASK-template.yaml`.

### Bước 5: Tạo Sprint Plan

Tạo file `.github-copilot/workspace/sprints/SPRINT-{date}.md`:
